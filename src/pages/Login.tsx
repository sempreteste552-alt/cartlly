      ...
      <div className="relative w-full max-w-md">
        ...
        <Card className="relative w-full border-0 shadow-2xl rounded-2xl bg-card z-10">
          <CardHeader className="text-center space-y-4 pt-8">
            ...
            <img src={sslGoogleImg} alt="Site Seguro SSL e Google" className="mx-auto h-24 object-contain" />
          ...
          <CardContent className="pb-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                ...
                disabled={loading || (isRegister && !acceptedTerms) || (!isForgotPassword && !turnstileToken)}
              >
