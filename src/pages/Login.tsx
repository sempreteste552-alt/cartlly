...
export default function Login() {
  ...
  if (showMaintenance) {
    return (
      <MarketingBackground>
        <Card className="relative w-full border border-white/20 shadow-2xl rounded-[2.5rem] bg-white/10 backdrop-blur-md z-10">
  ...
  return (
    <MarketingBackground>
      <div className="relative w-full perspective-[1000px]">
        ...
        >
          <Card className="relative w-full border border-white/20 shadow-2xl rounded-[2.5rem] bg-white/10 backdrop-blur-md z-10 max-h-[90vh] overflow-y-auto">
