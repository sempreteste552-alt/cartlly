  ...
  if (!open) {
    return (
      <button
        ...
        className="fixed z-50 h-[60px] w-[60px] rounded-full shadow-xl hover:shadow-2xl transition-all flex items-center justify-center bottom-36 md:bottom-24 right-4 md:right-6 group"
