...
const FEATURE_COPY: Record<string, { hook: string; benefit: string; minPlan: string }> = {
  ...
  "Ferramentas de IA": { hook: "IA gera descrição, sugere preço e posts para redes sociais em segundos", benefit: "Enquanto você escreve na mão, a IA já otimizou SEO, precificou corretamente e gerou conteúdo para redes sociais que vende. Pare de operar no lento.", minPlan: "PREMIUM" },
