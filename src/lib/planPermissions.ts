...
export const FEATURE_CATALOG: Record<FeatureKey, FeatureMeta> = {
  ...
  loyalty_program:      { label: "Programa de Fidelidade", description: "Sistema de pontos e recompensas", minPlan: "FREE", category: "marketing" },
  referral_program:     { label: "Programa de Indicações", description: "Indicações com recompensas", minPlan: "FREE", category: "marketing" },
