...
export const fr: TranslationKeys = {
  ...
  sidebar: {
    ...
    referrals: "Parrainages (Boutique)",
    platformReferrals: "Parrainer et Gagner (Cartlly)",
    policies: "Politiques",
    loyalty: "Fidélité",
    profit: "Profit Réel",
  ...
  store: {
    ...
    discountCoupons: "Coupons de Réduction",
    zipPlaceholder: "Votre code postal (00000-000)",
    detectLocation: "Détecter ma position",
    shippingHelpPrefix: "Entrez votre code postal pour calculer la livraison, ou appuyez sur",
    shippingHelpSuffix: "pour le détecter.",
    shippingDeliveryHelpPrefix: "Entrez votre code postal pour calculer le coût de livraison, ou appuyez sur",
    shippingDeliveryHelpSuffix: "pour le détecter automatiquement.",
    links: "Liens",
    contact: "Contact",
  ...
  misc: {
    ...
    storeClosedMessage: "Nous sommes temporairement fermés. Revenez bientôt !",
    storeUnderConstruction: "Nous préparons nos produits pour vous. Revenez bientôt pour découvrir les nouveautés !",
