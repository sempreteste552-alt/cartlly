-- Change the view to be security definer (default) so it doesn't check the current user's permissions,
-- this allows anonymous users to see store settings through the view without having access to the underlying table.
