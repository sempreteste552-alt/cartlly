...
ALTER TABLE public.store_settings ADD COLUMN IF NOT EXISTS favicon_url TEXT DEFAULT NULL;

-- Drop and recreate the public view with all columns including favicon_url
...
SELECT
  ...
  page_bg_color, header_text_color, banner_mobile_format
