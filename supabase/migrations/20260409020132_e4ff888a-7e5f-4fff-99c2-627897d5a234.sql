-- Update handle_product_out_of_stock to include search_path
...
-- Create trigger function for variants
...
DROP TRIGGER IF EXISTS tr_variant_out_of_stock ON public.product_variants;
CREATE TRIGGER tr_variant_out_of_stock
AFTER UPDATE ON public.product_variants
FOR EACH ROW
EXECUTE FUNCTION public.handle_variant_out_of_stock();
